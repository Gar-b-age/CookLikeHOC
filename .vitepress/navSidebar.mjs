...
function encodeSegment(name, locale) {
...
function dirDisplayName(dir, locale) {
  if (locale === 'en') {
...
export function generateNavAndSidebar(rootDir, locale = 'zh') {
  ...
  const nav = navEntries.length ? [{ text: navLabel, items: navEntries }] : []
